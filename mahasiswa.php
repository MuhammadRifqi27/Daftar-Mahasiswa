<?php
require 'proses.php';
$data_mahasiswa= query("SELECT * FROM tb_mahasiswa");

//tombol cari di klik
if (isset($_POST["search"])) {
    $data_mahasiswa = search($_POST["keyword"]);
}
?>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="krs/krs.php">
            ...
            <div class="container-fluid">
                ...
                <p class="mb-4">Berikut ini adalah Data Mahasiswa Universitas Teknologi Yogyakarta</p>
                ...
                <div class="card shadow mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col d-flex justify-content-end">
                                <ul class="nav nav-pills card-header-pills">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="mahasiswa/tambah.php"><i class="fas fa-plus"></i> Tambah Data</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col d-flex justify-content-end">
                                <form class="input-group" action="" method="POST">
                                    <input class="form-control" type="search" size="20" placeholder="Cari Mahasiswa" name="keyword" aria-label="Search" autocomplete="off">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active"><a href="mahasiswa.php">Dashboard</a></li>
                        </ol>
                    </nav>
                    <!-- Navbar Search-->
                    <table class="table table-bordered">
                            ...
                            <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="mahasiswa/edit.php?id=<?= $row["nim_mhs"]; ?>" class="btn btn-warning"><i class="fas fw fa-edit"></i> Edit</a>
                                            <a href="mahasiswa/hapus.php?id=<?= $row["nim_mhs"]; ?>" onclick="return confirm('yakin mau dihapus?');"  class="btn btn-danger"><i class="fas fw fa-trash"></i> Delete</a>
                                        </td>
                                    </tr>
