                            ...
                            <div class="col">
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        ...
                                        <a href="mahasiswa.php" class="btn btn-primary btn-user btn-block">
                                            Login
                                        </a>
                                        <hr>
                                        <a href="mahasiswa.php" class="btn btn-google btn-user btn-block">
                                            <i class="fab fa-google fa-fw"></i> Login with Google
                                        </a>
                                        <a href="mahasiswa.php" class="btn btn-facebook btn-user btn-block">
